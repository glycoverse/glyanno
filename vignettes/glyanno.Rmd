...
`enhance_struc_denovo()` reconstructs basic N-glycans from their conserved core
and branches, returning one topological candidate per input.
...
For now, `enhance_struc_denovo()` can only be used to enhance "basic" glycans to "topological" ones.
