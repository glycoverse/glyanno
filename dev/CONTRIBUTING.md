...
This outlines how to propose a change to glyanno. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyanno", fork = TRUE)`.
...
Please note that the glyanno project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyanno/dev/CODE_OF_CONDUCT.md).
