...
Thanks for using glyanno! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/glycoverse/glyanno/issues/new).
...
requests](https://github.com/glycoverse/glyanno/issues) to make sure the
