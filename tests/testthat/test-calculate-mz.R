...
test_that("calculate_mz works for glycan compositions", {
  comp <- glyrepr::glycan_composition(c(
    Hex = 5,
    HexNAc = 4,
    dHex = 1,
    NeuAc = 2
...
test_that("calculate_mz works for unsupported monosaccharides with safe = FALSE", {
  comp <- glyrepr::glycan_composition(
    c(Hep = 1),
...
test_that("calculate_mz works for permethylated glycans", {
  mz <- calculate_mz(
    "HexNAc(2)Hex(3)",
    charge = 0,
    mass_dict = glyanno_mass_dict(deriv = "permethyl")
  )
...
test_that("calculate_mz works for peracetylated glycans", {
  mz <- calculate_mz(
    "HexNAc(2)Hex(3)",
    charge = 0,
    mass_dict = glyanno_mass_dict(deriv = "peracetyl")
  )
...
test_that("calculate_mz works for average mass", {
  mz <- calculate_mz(
    "HexNAc(2)Hex(3)",
    charge = 0,
    mass_dict = glyanno_mass_dict(mass_type = "average")
  )
